...
export default function ProjectPage({ project, content }: ProjectPageProps) {
  const { title, category, description, headerImage, images, tags, url, slug, visitable } = project;
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#FF4B3A] overflow-y-auto">
        {/* Top nav */}
        <nav className="px-4 sm:px-8 md:px-12 lg:px-24 py-6 opacity-0 animate-fadeIn" aria-label="Project navigation">
